...
@Component({
  selector: 'app-carrousel-roteiro1-dia3',
  templateUrl: './carrousel-roteiro1-dia3.component.html',
  styleUrls: ['./carrousel-roteiro1-dia3.component.css']
})
export class CarrouselRoteiro1Dia3Component implements OnInit {
