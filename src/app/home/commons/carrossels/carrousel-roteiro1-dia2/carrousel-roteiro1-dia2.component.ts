...
@Component({
  selector: 'app-carrousel-roteiro1-dia2',
  templateUrl: './carrousel-roteiro1-dia2.component.html',
  styleUrls: ['./carrousel-roteiro1-dia2.component.css']
})
export class CarrouselRoteiro1Dia2Component implements OnInit {
